document.addEventListener("DOMContentLoaded", () => {
  ...
  examForm.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      console.log(payload)
      const response = await fetch("https://quizwiz-bcn5.onrender.com/quiz/exam/create", {
        method: "POST",
        headers: {
      ...
      const roomResponse = await fetch(`https://quizwiz-bcn5.onrender.com/quiz/generate-room/${examId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`

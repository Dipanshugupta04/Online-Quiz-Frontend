...
try {
const response = await fetch('https://quizwiz.ap-south-1.elasticbeanstalk.com/api/edit-profile', {
  method: 'PUT',
  headers: {
...
async function uploadProfilePicture(file) {
  ...
  try {
    const response = await fetch(
      "https://quizwiz.ap-south-1.elasticbeanstalk.com/profile/upload-profile-picture",
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
...
async function refreshProfilePicture() {
  ...
  try {
    const response = await fetch(
      "https://quizwiz.ap-south-1.elasticbeanstalk.com/profile/profile-picture",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
async function refreshProfileDetails() {
  document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
      const response = await fetch("https://quizwiz.ap-south-1.elasticbeanstalk.com/api/user", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
